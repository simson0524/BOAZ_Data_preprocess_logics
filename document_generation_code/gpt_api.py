...
document_form_2 = {
    ...
    "안전 사고/사고 보고서" : "사고자 이름, 사번, 연락처, 응급 연락처, 사고 일시, 장소, 상황, 부상 정도, 조치 내용, 작성자, 승인자"
    }
...
document_form_4 = {
    ...
    "고객 불만/클레임 처리 보고서" : "고객 이름, 연락처, 담당자 이름, 사번, 불만 내용, 처리 과정, 처리 결과, 대응 담당자, 작성일, 승인자"
    }
...
document_form_5 = {
    ...
    "유지보수 계획서 / 유지보수 일정표" : "담당 엔지니어 이름, 사번, 연락처, 고객사명, 설비명, 작업일시, 작업 내용, 투입 인력, 작성일, 검토자",
    "긴급 대응 기록 / 사고 대응 보고서" : "담당자 이름, 사번, 연락처, 고객 연락처, 사고 일시, 장소, 장애 내용, 조치 내역, 사용 부품, 대응 엔지니어, 작성자, 승인자",
    "설비 개선/업그레이드 보고서" : "담당 엔지니어 이름, 사번, 개선 내용, 적용 설비, 작업 일시, 예상 효과, 테스트 결과, 작성일, 승인자"
    }

# key : value -> 문서 유형 : 주요 내용 형식의 dict값
dep_to_id = {"인사부" : 1, "생산부" : 2, "관리부" : 3, "영업부" : 4, "기술부" : 5}
...
WW_GPT_API_KEY = os.environ.get("JH_LABELBOX_API_KEY")




def generate_data(company, employment, department, target, n, document_form, api_key = WW_GPT_API_KEY):
    ...
    직원정보 :"{employment}"
    다음은 회사의 정보와 직원 리스트야.
    이 회사에서는 다양한 내부문건들이 생성되는데, 그 중 종류와 형태는 "{document_form}" 이렇게 구성되어있어.
    ...
    *표의 "문서명" 칼럼은 생성된 json 문서명을 따라 가면 돼
    ...
    response = client.responses.create(
        model="gpt-5-mini",      # 필요에 따라 모델명 변경 가능 (예: "gpt-4.1-mini")
        input=prompt3,
