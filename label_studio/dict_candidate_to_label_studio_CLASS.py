...
#     upload_candidate_to_dictionary = [
#         {"sentence": "홍길동은 서울에 거주한다.", "span_token": "홍길동", "z_score": 2.13, "domain_id": "D001"},
#         {"sentence": "기밀 문서가 발견되었다.", "span_token": "기밀 문서", "z_score": 1.89, "domain_id": "D002"},
#     ]

#     manager = DictionaryCandidateLabeler(LABEL_STUDIO_URL, API_KEY)
#     project = manager.run_pipeline(is_pii=True, candidate_list=upload_candidate_to_dictionary)
