...
class ManualValidationLabeler:
    ...
    def create_project(self, is_pii: bool, total_count: int):
        ...
        <View>
            ...
            <Header value="Q. 아래 문장을 {info_type} 데이터셋에 추가하시겠습니까?" size="24"/>

            <View style="margin-top: 15px"/>
            <Text name="generated_sentence" value="$generated_sentence"/>


            <View style="margin-top: 20px"/>
            
            <Text name="span_token" value="span_token: $span_token" style="font-size:12px; color:gray;"/>
            <View style="margin-top: 15px"/>
            <Text name="validated_label" value="validated_label: $validated_label" style="font-size:12px; color:gray;"/>
            <View style="margin-top: 15px"/>
            <Text name="dataset_id" value="dataset_id: $dataset_id" style="font-size:12px; color:gray;"/>


            <View style="margin-top: 20px"/>
            
            <Choices name="choice" toName="generated_sentence" choice="single">
                <Choice value="예"/>
                <Choice value="아니오"/>
            </Choices>
        </View>
                    ...
                    for r in ann.get("result", []):
                        ...
                        if choice == "예":
                            manual_chk_completed_list.append({
                                ...
                                "dataset_id": task.data["dataset_id"],
                            })
